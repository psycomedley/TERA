...
HRESULT cAlphaText::Setup(E_FONT_TYPE eType, string sText, float fShowTime,
...
{
	cText::Setup(eType, sText, fShowTime, vPosition, stSize, dwColor, dwFormat);
...
bool cAlphaText::Update(float fPassedTime)
{
